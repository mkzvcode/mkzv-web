  ...
  useEffect(() => {
    ...
    const cards = Array.from(
      document.querySelectorAll<HTMLElement>(
        "main .service-card, main .project-card, main .process-card, main article.panel, main form.panel, main section article:not(.panel), main .signal-track, main .contact-link",
      ),
    );
